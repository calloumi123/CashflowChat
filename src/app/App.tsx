...
// Import from the index.ts file, not directly from supervisorAgent.ts
        ...
        const getCompanyName = (key: string) => {
          switch (key) {
            case 'customerServiceRetail':
              return customerServiceRetailCompanyName;
            case 'chatSupervisor':
              return chatSupervisorCompanyName;
            default:
              return 'CashFlowChat'; // fallback
          }
        };

        const companyName = getCompanyName(agentSetKey);
